...
function install_wine() {
    ...
    wget --show-progress -O wine-8.6-staging-tkg-amd64.tar.xz https://github.com/Kron4ek/Wine-Builds/releases/download/8.7/wine-8.7-staging-amd64.tar.xz
    tar -xf wine-8.7-staging-amd64.tar.xz # Extract Wine
