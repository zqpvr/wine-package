...
function install_wine() {
    ...
    case $choice in
        1)
            dialog --infobox "Installing wine-8.12-staging-tkg-amd64..." $DIALOG_HEIGHT $DIALOG_WIDTH
            wget --show-progress -O wine-8.12-staging-tkg-amd64.tar.xz https://github.com/Kron4ek/Wine-Builds/releases/download/8.12/wine-8.12-staging-tkg-amd64.tar.xz
            tar -xf wine-8.12-staging-tkg-amd64.tar.xz # Extract Wine
            ;;
        2)
