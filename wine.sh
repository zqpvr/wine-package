...
function install_wine() {
    ...
    case $choice in
        ...
        2)
            ...
            wget --show-progress -O wine-lutris-GE-Proton8-7-x86_64.tar.xz https://github.com/GloriousEggroll/wine-ge-custom/releases/download/GE-Proton8-7/wine-lutris-GE-Proton8-7-x86_64.tar.xz
            tar -xf wine-lutris-GE-Proton8-7-x86_64.tar.xz # Extract Wine-GE custom release
            ;;
        *)
